...
<div class="menu_area" style="text-align:right;">
	...
	<c:when test="${not empty sessionScope.memberId and 
		...
		<c:if test="${sessionScope.grade == 'A'}">
			...
			<button type="button" class="btn btn-success btn-lg" onclick="location.href='/pcm/controller?action=noticeInput'" style="width:auto;">공지 관리</button>
		...
		%>
			<table width="400px" border="1" align="right">
				<tr>
					<td  width="100px">
					좌석번호 
					</td>
...
<table width="500px" height="300"border="3" align="right">
<tr> 
